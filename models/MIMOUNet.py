...
class CustomAttentionModule(nn.Module):
    def __init__(self, channel):
        ...
        self.spatial = SpatialAttentionMap(channel)

    def forward(self, x1, x2):
        att_map = self.spatial(x1)
        x = x1 * x2
        x = x * att_map
        out = x1 + self.merge(x)
        return out
...
class SpatialAttentionMap(nn.Module):
    def __init__(self, channel):
        ...
        self.conv = nn.Conv2d(2, 1, padding=1, kernel_size=3)
...
class MIMOUNet(nn.Module):
    def __init__(self, num_res=8):
        ...
        self.CAM1 = CustomAttentionModule(base_channel * 4)
        self.SCM1 = SCM(base_channel * 4)
        self.CAM2 = CustomAttentionModule(base_channel * 2)
...
class MIMOUNetPlus(nn.Module):
    def __init__(self, num_res=20):
        ...
        self.FAM1 = CustomAttentionModule(base_channel * 4)
        self.SCM1 = SCM(base_channel * 4)
        self.FAM2 = CustomAttentionModule(base_channel * 2)
        self.SCM2 = SCM(base_channel * 2)
